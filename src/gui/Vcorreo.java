...
public class Vcorreo extends javax.swing.JDialog {
    ...
    private void btnNuevoMensajeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoMensajeActionPerformed
        fa.nuevoMensaje(correoUsuario, null,null);
    }//GEN-LAST:event_btnNuevoMensajeActionPerformed

    private void btnResponderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResponderActionPerformed
        fa.nuevoMensaje(correoUsuario, mensajes.get(tablaMensajes.getSelectedRow()).getCorreoRemitente(),"Re: "+mensajes.get(tablaMensajes.getSelectedRow()).getAsunto());
